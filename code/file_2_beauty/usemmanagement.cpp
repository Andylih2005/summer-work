...
void usemmanagement::paintEvent(QPaintEvent *event)
{
...
void usemmanagement::mousePressEvent(QMouseEvent *event)
{
...
void usemmanagement ::mouseMoveEvent(QMouseEvent *event)
{
...
void usemmanagement::on_btnClose_clicked()
{
    this->close();
}
