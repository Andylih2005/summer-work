...
void changebook::paintEvent(QPaintEvent *event)
{
...
void changebook::mousePressEvent(QMouseEvent *event)
{
...
void changebook ::mouseMoveEvent(QMouseEvent *event)
{
...
void changebook::on_btnClose_clicked()
{
    this->close();
}
